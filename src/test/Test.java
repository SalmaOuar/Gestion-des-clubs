...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Club club1 = clubService.findById(1);
        Club club2 = clubService.findById(2);

        if (club1 == null) {
            clubService.create(new Club("Club Informatique", "Développement et programmation", new Date()));
        }

        if (club2 == null) {
            clubService.create(new Club("Club Robotique", "Innovation", new Date()));
        }
       ...
       // Club club1 = new Club(1, "Club Informatique", "Développement et programmation", new Date());
        ...
        Etudiant etudiant1 = new Etudiant(1, "Ouarrar", "Salma", "SalmaOuarrar@gmail.com");
